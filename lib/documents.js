...
var types = exports.types = {
    ...
    unrecognizedContent: "unrecognizedContent"
};
...
function Paragraph(children, properties) {
    ...
    return {
        ...
        marginLeft: properties.marginLeft || null
    };
}
...
function Table(children, properties, tableGrid, alignment) {
    properties = properties || {};
    return {
        type: types.table,
        children: children,
...
function UnrecognizedContent(options) {
    return {
        type: types.unrecognizedContent,
        elType: options.type
    };
}
...
exports.UnrecognizedContent = UnrecognizedContent;
